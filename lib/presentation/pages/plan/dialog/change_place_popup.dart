...
/// 장소 수정 하기 팝업
class ChangePlacePopup extends StatefulWidget {
  final Place newPlace;

  const ChangePlacePopup({required this.newPlace, super.key});

  @override
  State<ChangePlacePopup> createState() => _ChangePlacePopupState();
}

class _ChangePlacePopupState extends State<ChangePlacePopup> with PlanUtil {
        ...
        child: Text.rich(
          TextSpan(
            children: [
              ...
              TextSpan(
                  text: "${getPostposition(widget.newPlace.placeName)}\n장소를 수정하시겠습니까?",
                    ...
                    title: Wrap(
                      ...
                      children: [
                        ...
                        Transform.translate(
                            offset: Offset(-5, 0),
                            child:
                                buildWalkTravelTime(widget.newPlace.walkTravelTime)),
                      ],
                    ),
                  ),
                ),
                    ...
                    title: Wrap(
                      ...
                      children: [
                        ...
                        Transform.translate(
                            offset: Offset(-6, 0),
                            child:
                                buildCarTravelTime(widget.newPlace.carTravelTime)),
                      ],
                    ),
                  ),
                ),
