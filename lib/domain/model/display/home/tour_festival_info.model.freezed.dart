...
TourFestivalInfoModel _$TourFestivalInfoModelFromJson(
    Map<String, dynamic> json) {
  return _TourFestivalInfoModel.fromJson(json);
}

/// @nodoc
mixin _$TourFestivalInfoModel {
  String get addr1 =>
  ...
  @JsonKey(ignore: true)
  $TourFestivalInfoModelCopyWith<TourFestivalInfoModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TourFestivalInfoModelCopyWith<$Res> {
  factory $TourFestivalInfoModelCopyWith(TourFestivalInfoModel value,
          $Res Function(TourFestivalInfoModel) then) =
      _$TourFestivalInfoModelCopyWithImpl<$Res, TourFestivalInfoModel>;
  @useResult
  $Res call(
      {String addr1,
      String addr2,
...
/// @nodoc
class _$TourFestivalInfoModelCopyWithImpl<$Res,
        $Val extends TourFestivalInfoModel>
    implements $TourFestivalInfoModelCopyWith<$Res> {
  _$TourFestivalInfoModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$TourFestivalInfoModelImplCopyWith<$Res>
    implements $TourFestivalInfoModelCopyWith<$Res> {
  factory _$$TourFestivalInfoModelImplCopyWith(
          _$TourFestivalInfoModelImpl value,
          $Res Function(_$TourFestivalInfoModelImpl) then) =
      __$$TourFestivalInfoModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String addr1,
...
/// @nodoc
class __$$TourFestivalInfoModelImplCopyWithImpl<$Res>
    extends _$TourFestivalInfoModelCopyWithImpl<$Res,
        _$TourFestivalInfoModelImpl>
    implements _$$TourFestivalInfoModelImplCopyWith<$Res> {
  __$$TourFestivalInfoModelImplCopyWithImpl(_$TourFestivalInfoModelImpl _value,
      $Res Function(_$TourFestivalInfoModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$TourFestivalInfoModelImpl(
      addr1: null == addr1
          ? _value.addr1
          : addr1 // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$TourFestivalInfoModelImpl implements _TourFestivalInfoModel {
  const _$TourFestivalInfoModelImpl(
      {required this.addr1,
      required this.addr2,
  ...
  factory _$TourFestivalInfoModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$TourFestivalInfoModelImplFromJson(json);
...
// 전화번호
  ...
  @override
  String toString() {
    return 'TourFestivalInfoModel(addr1: $addr1, addr2: $addr2, areacode: $areacode, booktour: $booktour, cat1: $cat1, cat2: $cat2, cat3: $cat3, contentid: $contentid, contenttypeid: $contenttypeid, createdtime: $createdtime, eventstartdate: $eventstartdate, eventenddate: $eventenddate, firstimage: $firstimage, firstimage2: $firstimage2, cpyrhtDivCd: $cpyrhtDivCd, mapx: $mapx, mapy: $mapy, mlevel: $mlevel, modifiedtime: $modifiedtime, sigungucode: $sigungucode, tel: $tel, title: $title)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$TourFestivalInfoModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TourFestivalInfoModelImplCopyWith<_$TourFestivalInfoModelImpl>
      get copyWith => __$$TourFestivalInfoModelImplCopyWithImpl<
          _$TourFestivalInfoModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$TourFestivalInfoModelImplToJson(
      this,
    );
  }
}

abstract class _TourFestivalInfoModel implements TourFestivalInfoModel {
  const factory _TourFestivalInfoModel(
      ...
      required final String title}) = _$TourFestivalInfoModelImpl;

  factory _TourFestivalInfoModel.fromJson(Map<String, dynamic> json) =
      _$TourFestivalInfoModelImpl.fromJson;
