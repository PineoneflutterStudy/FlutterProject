...
part 'tour_detail_info.model.freezed.dart';
part 'tour_detail_info.model.g.dart';

/// ## 관광정보 서비스 - 행사 정보 Model

@freezed
class TourDetailInfoModel with _$TourDetailInfoModel {
  const factory TourDetailInfoModel({
  ...
  }) = _TourDetailInfoModel;



  factory TourDetailInfoModel.fromJson(Map<String, dynamic> json) =>
      _$TourDetailInfoModelFromJson(json);
}